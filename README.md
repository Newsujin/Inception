...
이 저장소는 **Docker**와 **Docker Compose**를 사용하여 `Nginx`, `WordPress + PHP-FPM`, `MariaDB` 를 각각 독립된 컨테이너로 구성하는 프로젝트입니다.
...
<img width="672" alt="스크린샷 2025-01-15 오후 6 39 14" src="https://github.com/user-attachments/assets/750da103-5ba6-4984-b19e-86fdb27aa41c" />
...
### PHP-FPM
<img width="1103" alt="스크린샷 2025-01-15 오후 6 36 53" src="https://github.com/user-attachments/assets/f42887b2-9e92-47af-b7e9-1c33417a608e" />
...
### CGI
<img width="984" alt="스크린샷 2025-01-15 오후 6 36 21" src="https://github.com/user-attachments/assets/b462bfb4-96c0-4780-bb53-47a8a1af01df" />
